...
const Input = ({ onSend, onCancel, isDark, isWaiting, isReading }) => {
  ...
  return (
    <div inert={isReading} className={`p-4 max-w-[1000px] mx-auto w-full `}>
        ...
        >
          ...
          <div className="absolute right-4 bottom-2 flex items-center space-x-1">
            ...
            {isWaiting ? (
              ...
              <button
                type="submit"
                disabled={!inputMessage.trim() || isReading}
